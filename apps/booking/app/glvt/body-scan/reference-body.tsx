    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} className="space-y-6">
        <TabsList className="grid w-full grid-cols-6">
          <TabsTrigger value="workouts" onClick={() => router.push("/body?tab=workouts")}>
            Workouts
          </TabsTrigger>
          <TabsTrigger value="history" onClick={() => router.push("/body?tab=history")}>
            <Activity className="h-4 w-4 mr-2" />
            History
          </TabsTrigger>
          <TabsTrigger value="metrics" onClick={() => router.push("/body?tab=metrics")}>
            <Activity className="h-4 w-4 mr-2" />
            Metrics
          </TabsTrigger>
          <TabsTrigger value="health" onClick={() => router.push("/body?tab=health")}>
            <Apple className="h-4 w-4 mr-2" />
            Health
          </TabsTrigger>
          <TabsTrigger value="nutrition" onClick={() => router.push("/body?tab=nutrition")}>
            <Apple className="h-4 w-4 mr-2" />
            Plan
          </TabsTrigger>
          <TabsTrigger value="devices" onClick={() => router.push("/body?tab=devices")}>
                      ...
                      <div className="space-y-4 pt-4">
                        ...
                        <Button
                          onClick={() => {
                            ...
                            router.push(`/workout-tracker?day=${workout.day}`);
                          }}
                          className="w-full bg-gradient-to-r from-primary to-primary-light text-white hover:opacity-90 h-12"
                        >
                          <Play className="mr-2 h-4 w-4" />
