...
const NutritionTargets = () => {
  ...
  const toast = (props: any) => console.log(props); // Stub
  ...
  const loadProfile = async () => {
    try {
      ...
      if (!data) {
        ...
        router.push("/body?tab=nutrition");
        return;
      }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" onClick={() => router.push("/body?tab=nutrition")}>
        ...
        <Button onClick={() => router.push("/food-tracking")}>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <Button variant="outline" className="w-full" onClick={() => router.push("/body?tab=nutrition")}>
              Edit Nutrition Plan
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <Button className="w-full" onClick={() => router.push("/food-tracking")}>
              <Utensils className="mr-2 h-4 w-4" />
              Track Food Today
            </Button>
          </CardContent>
