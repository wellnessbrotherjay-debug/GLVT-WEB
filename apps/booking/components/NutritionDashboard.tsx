            ...
            <Card className="bg-[#1A1A1A] border-[#333] text-white">
                ...
                <CardContent className="space-y-4">
                    <div>
                        ...
                        <Progress value={(stats?.proteinConsumed || 0) / (stats?.proteinTarget || 1) * 100} className="h-1.5 bg-[#333]" />
                    </div>
                    <div>
                        <div className="flex justify-between text-xs mb-1">
                        ...
                        <Progress value={(stats?.carbsConsumed || 0) / (stats?.carbsTarget || 1) * 100} className="h-1.5 bg-[#333]" />
                    </div>
                    <div>
                        <div className="flex justify-between text-xs mb-1">
                        ...
                        <Progress value={(stats?.fatConsumed || 0) / (stats?.fatTarget || 1) * 100} className="h-1.5 bg-[#333]" />
                    </div>
                </CardContent>
            </Card>
        </div>
